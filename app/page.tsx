      ...
      <section className="relative flex min-h-[55vh] md:min-h-[65vh] items-center justify-center overflow-hidden bg-[#091f36] px-4 py-16 sm:py-20 text-center shadow-2xl">
        ...
        <div className="relative z-10 mx-auto max-w-4xl space-y-6 sm:space-y-8">
          ...
          <h1 className="text-4xl sm:text-5xl md:text-7xl font-black uppercase tracking-tight text-white leading-none drop-shadow-xl">
            ...
            <span className="text-transparent bg-clip-text bg-gradient-to-r from-yellow-300 to-yellow-500">Fútbol Sala</span>
          </h1>
          ...
          <div className="flex flex-col items-center justify-center gap-3 sm:gap-4 pt-4 sm:flex-row w-full max-w-md mx-auto sm:max-w-none">
            ...
            <Link href="/jornadas" className="group w-full sm:w-auto inline-flex items-center justify-center gap-2 rounded-lg border-2 border-white/20 bg-white/5 px-6 sm:px-8 py-3.5 sm:py-4 text-sm font-bold uppercase tracking-wide text-white backdrop-blur-md transition-all hover:border-white/40 hover:bg-white/10 active:scale-95">
              Últimos Resultados
            </Link>
          </div>
        </div>
          ...
          <div className="grid gap-6 lg:grid-cols-3">
            ...
            <div className="rounded-2xl bg-white border border-slate-100 shadow-lg shadow-[#0b4a6f]/5 overflow-hidden">
              <div className="bg-gradient-to-r from-[#091f36] to-[#0b4a6f] px-5 py-4 flex items-center justify-between">
                <h2 className="text-base font-black uppercase tracking-tight text-white flex items-center gap-2"><span className="w-1 h-5 bg-yellow-400 rounded-full"></span>Clasificación</h2>
            ...
            <div className="rounded-2xl bg-white border border-slate-100 shadow-lg shadow-[#0b4a6f]/5 overflow-hidden">
              <div className="bg-gradient-to-r from-[#091f36] to-[#0b4a6f] px-5 py-4 flex items-center justify-between">
                <h2 className="text-base font-black uppercase tracking-tight text-white flex items-center gap-2"><span className="w-1 h-5 bg-yellow-400 rounded-full"></span>Últimos Resultados</h2>
            ...
            <div className="rounded-2xl bg-white border border-slate-100 shadow-lg shadow-[#0b4a6f]/5 overflow-hidden">
              <div className="bg-gradient-to-r from-[#091f36] to-[#0b4a6f] px-5 py-4 flex items-center justify-between">
                <h2 className="text-base font-black uppercase tracking-tight text-white flex items-center gap-2"><span className="w-1 h-5 bg-yellow-400 rounded-full"></span>Próximos Partidos</h2>
                <Link href="/jornadas" className="text-[10px] font-bold uppercase tracking-wider text-yellow-400 hover:text-yellow-300 transition-colors">Ver todo →</Link>
              </div>
              <div className="divide-y divide-slate-50">
          ...
          <div className="grid gap-10 lg:grid-cols-2 lg:gap-16 items-center">
            <div className="space-y-6 sm:space-y-8">
              <div className="space-y-2 text-center lg:text-left">
                ...
                <h3 className="text-3xl font-black uppercase tracking-tight text-slate-900 sm:text-4xl lg:text-5xl">Nuestra <span className="text-[#091f36]">Historia</span></h3>
              </div>
              <div className="space-y-4 sm:space-y-5 text-base sm:text-lg leading-relaxed text-slate-600">
                ...
                <p>Celebramos nuestros partidos en <strong>Torrelodones</strong>, con un mismo objetivo: disfrutar del fútbol sala.</p>
              </div>
            </div>
            <div className="relative rounded-[2rem] bg-[#091f36] p-6 sm:p-10 lg:p-12 text-white shadow-2xl overflow-hidden">
              ...
              <div className="relative z-10 space-y-5 sm:space-y-6">
                <h3 className="text-2xl font-black uppercase tracking-tight text-white sm:text-3xl lg:text-4xl text-center lg:text-left">El <span className="text-yellow-400">Espíritu</span></h3>
                <div className="space-y-3 sm:space-y-4 text-blue-100 text-base sm:text-lg">
                  <p>Aunque el objetivo principal es disfrutar, el espíritu competitivo también está muy presente.</p>
